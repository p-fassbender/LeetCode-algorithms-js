...
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 10)) // should return 4
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 6)) // should return 3
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 20)) // should return -1